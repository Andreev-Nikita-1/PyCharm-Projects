...
def armiho(fun, c=0.1, k=20, f0=None, df0=None):
    x = 1
    oracle = 0
...
def optimization_task(oracle, start, method='gradient descent', one_dim_search=None, args=(),
    ...
    while True:
        ...
        # в реализации в __main__.py стоит флаг no_function
        if not flag:
            fk = f_
            fc += 1
        gc += 1
...
print(oracle(wcc, X_cancer, labels_cancer))
exit(0)
...
a1, i1, t1, v1, r1, fc1, gc1, hc1 = optimization_task(oracle, w0_cancer, method='newton',
                                                      args=[X_cancer, labels_cancer, outers_cancer],
                                                      one_dim_search='wolf', max_time=0.1,
                                                      search_kwargs=dict([('c2', 0.9)]))
a2, i2, t2, v2, r2, fc2, gc2, hc2 = optimization_task(oracle, w0_cancer, method='newton',
                                                      args=[X_cancer, labels_cancer, outers_cancer],
                                                      one_dim_search='wolf', max_time=0.1,
                                                      search_kwargs=dict([('c2', 0.5)]))
a3, i3, t3, v3, r3, fc3, gc3, hc3 = optimization_task(oracle, w0_cancer, method='newton',
                                                      args=[X_cancer, labels_cancer, outers_cancer],
                                                      one_dim_search='wolf', max_time=0.1,
                                                      search_kwargs=dict([('c2', 0.3)]))
a4, i4, t4, v4, r4, fc4, gc4, hc4 = optimization_task(oracle, w0_cancer, method='newton',
                                                      args=[X_cancer, labels_cancer, outers_cancer],
                                                      one_dim_search='wolf', max_time=0.1,
                                                      search_kwargs=dict([('c2', 0.1)]))
a5, i5, t5, v5, r5, fc5, gc5, hc5 = optimization_task(oracle, w0_cancer, method='newton',
                                                      args=[X_cancer, labels_cancer, outers_cancer],
                                                      one_dim_search='wolf', max_time=0.1,
                                                      search_kwargs=dict([('c2', 0.001)]))
